...
// Roof wordmark SVG path (inline for email clients that strip external images)
        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:580px;background-color:#ffffff;">
          ...
          <tr>
            <td align="center" style="padding:0 32px 32px;">
              <h1 style="margin:0;font-size:30px;font-weight:800;line-height:1.15;color:#09090b;letter-spacing:-0.5px;text-align:center;">You're in. Now go find your place.</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 32px 24px;">
              <p style="margin:0 0 12px;font-size:16px;line-height:1.7;color:#09090b;">Hey ${firstName},</p>
              <p style="margin:0 0 12px;font-size:16px;line-height:1.7;color:#09090b;">Welcome to Roof! The only housing app that works harder than you do (and doesn't need coffee to do it).</p>
              <p style="margin:0 0 12px;font-size:16px;line-height:1.7;color:#09090b;">The Dutch rental market is fast. Like... blink-and-it's-gone fast. That's exactly why we built Roof. While you're living your life, we're watching Kamernet, Pararius, and more, and the moment something matches what you're looking for, we'll tell you first.</p>
              <p style="margin:0;font-size:16px;line-height:1.7;color:#09090b;">No more refreshing 6 tabs at midnight. No more arriving too late. Just you, a notification, and your future home.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 32px 32px;">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f1f5f9;border-radius:16px;padding:24px 24px 24px 24px;">
                <tr>
                  <td>
                    <p style="margin:0 0 16px;font-size:16px;font-weight:400;color:#09090b;line-height:1.5;">Here's how to make the most of Roof:</p>
                    <!-- Step 1 -->
                    <table cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:14px;">
                      <tr>
                        <td style="vertical-align:top;padding-top:1px;">
                          <span style="display:inline-block;min-width:20px;font-size:16px;font-weight:700;color:#09090b;line-height:1.5;">1.</span>
                        </td>
                        <td style="padding-left:8px;">
                          <p style="margin:0;font-size:16px;line-height:1.5;color:#09090b;"><strong>Set your search preferences</strong> — city, budget, room type. The more specific, the better we hunt.</p>
                        </td>
                      </tr>
                    </table>
                    <!-- Step 2 -->
                    <table cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:14px;">
                      <tr>
                        <td style="vertical-align:top;padding-top:1px;">
                          <span style="display:inline-block;min-width:20px;font-size:16px;font-weight:700;color:#09090b;line-height:1.5;">2.</span>
                        </td>
                        <td style="padding-left:8px;">
                          <p style="margin:0;font-size:16px;line-height:1.5;color:#09090b;"><strong>Turn on notifications</strong> — this is the whole game. Be first or be last.</p>
                        </td>
                      </tr>
                    </table>
                    <!-- Step 3 -->
                    <table cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td style="vertical-align:top;padding-top:1px;">
                          <span style="display:inline-block;min-width:20px;font-size:16px;font-weight:700;color:#09090b;line-height:1.5;">3.</span>
                        </td>
                        <td style="padding-left:8px;">
                          <p style="margin:0;font-size:16px;line-height:1.5;color:#09090b;"><strong>Apply fast</strong> — when you get the alert, don't overthink it. Move.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="center" style="padding:0 32px 32px;">
              <a href="https://getroof.app/app/rooms" style="display:inline-block;background-color:#18181b;color:#fafafa;font-size:14px;font-weight:500;text-decoration:none;padding:10px 20px;border-radius:6px;letter-spacing:0;">Set up my search</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 32px 32px;">
              <p style="margin:0 0 0;font-size:16px;line-height:1.7;color:#09090b;">Good luck out there — though with Roof, you won't need it.</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td>
                    ...
                    <p style="margin:0;font-size:12px;color:#a1a1aa;line-height:1.6;">You're receiving this because you created a Roof account. Questions? <a href="mailto:hello@getroof.app" style="color:#71717a;">hello@getroof.app</a></p>
                  </td>
                </tr>
              </table>
            </td>
