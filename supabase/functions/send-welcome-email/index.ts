...
<head>
  ...
  <title>You're in. Now go find your place.</title>
</head>
<body style="margin:0;padding:0;background-color:#f8f8f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f8f8f7;padding:40px 16px;">
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;background-color:#ffffff;border-radius:16px;overflow:hidden;">

          <!-- Header / Logo -->
          <tr>
            <td style="padding:40px 40px 32px;background-color:#ffffff;">
              <svg width="80" height="41" viewBox="0 0 272 140" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <tr>
            <td style="padding:0 40px 32px;">
              <h1 style="margin:0 0 16px;font-size:28px;font-weight:700;line-height:1.2;color:#09090b;letter-spacing:-0.5px;">You're in. Now go find your place.</h1>
              <p style="margin:0;font-size:16px;line-height:1.6;color:#52525b;">Hey ${firstName}, welcome to Roof!</p>
              <p style="margin:12px 0 0;font-size:16px;line-height:1.6;color:#52525b;">The Dutch rental market moves fast — listings on Pararius, Funda, and Kamernet disappear within hours. Roof aggregates every new listing the moment it goes live, so you're always first in line.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 40px 32px;">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f1f5f9;border-radius:12px;padding:24px;">
                <tr>
                  <td style="padding:0 0 6px;">
                    <p style="margin:0 0 20px;font-size:13px;font-weight:600;letter-spacing:0.05em;text-transform:uppercase;color:#71717a;">Get started</p>
                  </td>
                </tr>
                <tr>
                  <td>
                          ...
                          <table cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td style="width:28px;vertical-align:top;padding-top:2px;">
                                <span style="display:inline-block;width:22px;height:22px;background-color:#09090b;border-radius:50%;text-align:center;line-height:22px;font-size:12px;font-weight:700;color:#ffffff;">1</span>
                              </td>
                              <td style="padding-left:12px;">
                                <p style="margin:0;font-size:15px;font-weight:600;color:#09090b;">Set your preferences</p>
                                <p style="margin:4px 0 0;font-size:14px;color:#71717a;line-height:1.5;">Tell Roof your budget, location, and housing type — we'll filter the noise for you.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td style="padding:0 0 16px;">
                          <table cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td style="width:28px;vertical-align:top;padding-top:2px;">
                                <span style="display:inline-block;width:22px;height:22px;background-color:#09090b;border-radius:50%;text-align:center;line-height:22px;font-size:12px;font-weight:700;color:#ffffff;">2</span>
                              </td>
                              <td style="padding-left:12px;">
                                <p style="margin:0;font-size:15px;font-weight:600;color:#09090b;">Turn on notifications</p>
                                <p style="margin:4px 0 0;font-size:14px;color:#71717a;line-height:1.5;">Get alerted the second a matching listing appears — before it fills up.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td>
                          <table cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              <td style="width:28px;vertical-align:top;padding-top:2px;">
                                <span style="display:inline-block;width:22px;height:22px;background-color:#09090b;border-radius:50%;text-align:center;line-height:22px;font-size:12px;font-weight:700;color:#ffffff;">3</span>
                              </td>
                              <td style="padding-left:12px;">
                                <p style="margin:0;font-size:15px;font-weight:600;color:#09090b;">Apply fast</p>
                                <p style="margin:4px 0 0;font-size:14px;color:#71717a;line-height:1.5;">Roof drafts your intro message automatically. One tap to send, before anyone else does.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
          ...
          <tr>
            <td style="padding:0 40px 40px;">
              <a href="https://getroof.nl/app/rooms" style="display:inline-block;background-color:#09090b;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:100px;letter-spacing:-0.1px;">Set up my search →</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px 40px;">
              <p style="margin:0;font-size:15px;line-height:1.6;color:#52525b;">Good luck out there — Amsterdam (and the rest of the Netherlands) is waiting.</p>
              <p style="margin:16px 0 0;font-size:15px;color:#52525b;">The Roof team</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:24px 40px;background-color:#fafafa;border-top:1px solid #f4f4f5;">
              <p style="margin:0;font-size:12px;color:#a1a1aa;line-height:1.6;">You're receiving this because you created a Roof account. Questions? Reply to this email or contact us at <a href="mailto:hello@getroof.nl" style="color:#52525b;">hello@getroof.nl</a></p>
            </td>
          </tr>
  ...
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: FROM_EMAIL,
        to: email,
        subject: "You're in. Now go find your place.",
